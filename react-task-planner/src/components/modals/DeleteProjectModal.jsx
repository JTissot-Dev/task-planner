...
const DeleteProjectModal = ({loading, deleteProject, setDeleteProjectModal}) => {
   
  const clickOutside = useOutsideClick(() => setDeleteProjectModal(prev => !prev));
      ...
      <div className="relative w-full max-w-lg max-h-full">
          ...
          >
              ...
              <div className="p-6 border-y border-zinc-50 border-opacity-50 pt-4 space-y-2">
                <p>Souhaitez-vous vraiment supprimer le projet?</p>
              </div>
