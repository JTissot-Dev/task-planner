...
const Header = ({ userName, setOpenModal, toggleSideBar, sideMenuDisplay, sideBar }) => {
  ...
  return (
    <>
      <header className="fixed top-0 w-full flex justify-between items-center h-14 bg-slate-950 bg-opacity-50 backdrop-blur z-50 border-b border-zinc-50 border-opacity-50">
