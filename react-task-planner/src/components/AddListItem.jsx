    ...
    >
    {
      ...
      (
        <form 
          ...
          className="w-full p-3 bg-slate-800 bg-opacity-40 rounded-lg"
          ref={ useOutside }>
          <input
            type="text"
      ...
      (
      <button
        className="p-3 w-full flex items-center text-sm transition duration-200 hover:ease-in-out bg-slate-800 bg-opacity-40 hover:bg-purple-800 hover:bg-opacity-50 rounded-lg"
